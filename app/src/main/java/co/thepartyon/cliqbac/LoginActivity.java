...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //TODO: sharedpreferences = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        }
    }

    private boolean isPhoneValid(String phone) {
        //TODO: Replace this with your own logic
        return true;//phone.matches("\\d{10}");
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        while (!cursor.isAfterLast()) {
            phoneNums.add(cursor.getString(ProfileQuery.ADDRESS));
            cursor.moveToNext();
        }

        addPhoneNumsToAutoComplete(phoneNums);
    }
    ...
    private void addPhoneNumsToAutoComplete(List<String> phoneNumCollection) {
        //Create adapter to tell the AutoCompleteTextView what to show in its dropdown list.
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivity.this,
                        android.R.layout.simple_dropdown_item_1line, phoneNumCollection);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            // TODO: register the new account here in a SQLite Database which will communicate w/ PostGRE? Ask Arash about this.
